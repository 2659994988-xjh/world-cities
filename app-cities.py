...
sns.set_theme()
st.title('World Cities Data Analysis')
df = pd.read_csv('c:/Users/wzq/Desktop/My-streamlit/.vscode/worldcities.csv')
...
if country_filter!='ALL':df = df[df.country == country_filter]
# show on map
st.map(df)
# show dataframe
